...
<head>
	...
	<title>MEO: Owner Reset Password</title>
	<style>
		section{
			width: 100% !important
		}
...
<body>
	...
	<div class="text-right row p-2" style="background-color: #fff">
		<div class="col-lg-12" >
			ARE YOU LOOKING FOR 
			<button type="button" class="btn btn-outline-primary mx-2 active" onclick="redirectLogin('owner')" style="width: fit-content;">Owner Login</button>
			OR
	...
	<main role="main" class="container-fluid col-lg-3 mt-rem-5">
		...
		<div class="card">
			...
			<div class="card-body text-center">
				<script type="text/javascript" src="https://c1abn983.caspio.com/dp/ded080002b3bc90d80884e52b04c/emb"></script>
				<hr>
