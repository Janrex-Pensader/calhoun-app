...
<head>
	...
	<title>MEO: Reset Password</title>
	<style>
		section{
			width: 100% !important
		}
...
<body>
	...
	<div class="text-right row p-2" style="background-color: #fff">
		<div class="col-lg-12" >
			...
			OR
			<button type="button" class="btn btn-outline-primary mx-2" onclick="redirectLogin('staff')" style="width: fit-content;">Staff Login</button>
			OR
			<button type="button" class="btn btn-outline-primary mx-2 active" onclick="redirectLogin('attorney')" style="width: fit-content;">Attorney Login</button>
		</div>
	</div>
	...
	<main role="main" class="container-fluid col-lg-3 mt-rem-5">
		...
		<div class="card">
			<div class="card-header" style="background-color: #D5DCF9; color: #677FE6">
				<div class="row">
					<div class="col-md-8 m-auto">
						<div class="row">
							<span class="h6 font-weight-bold">Forgot your password?</span>
						</div>
						<div class="row">
							We got you covered!
						</div>
			...
			<div class="card-body text-center">
                <script type="text/javascript" src="https://c1abn983.caspio.com/dp/ded080005fc5ec84a1594c1287a8/emb"></script>
				<hr>
				<a href="./attorney-login.php"><i class="fas fa-lock mr-2"></i>Back to Login</a>
			</div>
		</div>
	</main>
	<!-- /.container -->
