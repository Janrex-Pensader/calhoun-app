...
<body>
	...
	<div class="text-right row p-2" style="background-color: #fff">
		<div class="dropdown col-lg-12">
			<button class="btn btn-primary dropdown-toggle mx-2" style="width: fit-content" type="button" data-toggle="dropdown" aria-expanded="false">
				Staff
			</button>
			LOGIN
			<div class="dropdown-menu">
				<a class="dropdown-item" href="#" onclick="redirectLogin('owner')">Client</a>
				<a class="dropdown-item active" href="#" onclick="redirectLogin('staff')">Staff</a>
