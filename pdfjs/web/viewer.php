...
<head>
  ...
  <title>PDF.js sviewer</title>

  <link rel="stylesheet" href="viewer.css">

  <!-- This snippet is used in production (included from viewer.html) -->
  <link rel="resource" type="application/l10n" href="locale/locale.properties">
  <script src="<?php echo auto_version('../build/pdf.js'); ?>"></script>

  <script src="<?php echo auto_version('load.js'); ?>"></script>
  <script src="<?php echo auto_version('viewer.js'); ?>"></script>
