...
/***/ (function (module, exports, __webpack_require__) {
            ...
            while (1) {
              switch (_context7.prev = _context7.next) {
                ...
                case 3:
                  ...
                  // after getting the base64, process the PDF
                  let int = setInterval(() => {
                    // wait for the DP to load
                    // load file URL
                    if (file_link) {
                    ...
                    let b64 = document.querySelector('.cbform .cbspan').getAttribute('cb-data')
                    if (b64) {
                      // convert to DataURI
                      let pdfAsDataUri = "data:application/pdf;base64," + b64;
                      // convert to Binary
    ...
    {
      var HOSTED_VIEWER_ORIGINS = ['null', 'http://mozilla.github.io', 'https://mozilla.github.io', 'http://ph-dws08', 'https://www.mswcompliance.com', 'https://mswcompliance.com'];
